		...
		<div className="flex flex-col">
			<div className="flex flex-col bg-slate-200 py-spacing-lg">
				<div className="container space-y-spacing-sm">
					...
					<p className="text-sm">Following demo executes scroll in RequestAnimationFrame and <strong>do not</strong> uses a <a className="text-link" href="https://developer.mozilla.org/en-US/docs/Glossary/Throttle" target="_blank" rel="noopener noreferrer">throttle</a> function which would utilized in the production. Performance can be tracked with stats.</p>
				</div>
			</div>
			<PronotronIOProvider>
