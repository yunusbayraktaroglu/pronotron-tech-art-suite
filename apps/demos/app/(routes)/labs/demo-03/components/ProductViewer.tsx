...
function UnibodyPicture()
{
	return (
		<picture>
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/unibody__eublzdgtajo2_small.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/unibody__eublzdgtajo2_small_2x.jpg 2x` } media="(max-width:734px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/unibody__eublzdgtajo2_medium.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/unibody__eublzdgtajo2_medium_2x.jpg 2x` } media="(max-width:1068px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/unibody__eublzdgtajo2_large.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/unibody__eublzdgtajo2_large_2x.jpg 2x` } media="(min-width:0px)" />
			<img src={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/unibody__eublzdgtajo2_large.jpg` } alt="" className="w-full" />
		</picture>
	)
}
...
function CameraControlPicture()
{
	return (
		<picture>
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/camera_control__cy5kilwa0kwi_small.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/camera_control__cy5kilwa0kwi_small_2x.jpg 2x` } media="(max-width:734px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/camera_control__cy5kilwa0kwi_medium.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/camera_control__cy5kilwa0kwi_medium_2x.jpg 2x` } media="(max-width:1068px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/camera_control__cy5kilwa0kwi_large.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/camera_control__cy5kilwa0kwi_large_2x.jpg 2x` } media="(min-width:0px)" />
			<img src={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/camera_control__cy5kilwa0kwi_large.jpg` } alt="" className="w-full" />
		</picture>
	)
}
...
function CeramicPicture() {
	return (
		<picture>
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/ceramic_shield__de0653vp43cm_small.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/ceramic_shield__de0653vp43cm_small_2x.jpg 2x` } media="(max-width:734px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/ceramic_shield__de0653vp43cm_medium.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/ceramic_shield__de0653vp43cm_medium_2x.jpg 2x` } media="(max-width:1068px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/ceramic_shield__de0653vp43cm_large.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/ceramic_shield__de0653vp43cm_large_2x.jpg 2x` } media="(min-width:0px)" />
			<img src={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/ceramic_shield__de0653vp43cm_large.jpg` } alt="" className="w-full" />
		</picture>
	)
}
...
function ProDisplayPicture()
{
	return (
		<picture>
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/pro_display__c0jmzc5emcae_small.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/pro_display__c0jmzc5emcae_small_2x.jpg 2x` } media="(max-width:734px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/pro_display__c0jmzc5emcae_medium.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/pro_display__c0jmzc5emcae_medium_2x.jpg 2x` } media="(max-width:1068px)" />
			<source srcSet={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/pro_display__c0jmzc5emcae_large.jpg, ${ process.env.NEXT_PUBLIC_BASE_PATH }/pro_display__c0jmzc5emcae_large_2x.jpg 2x` } media="(min-width:0px)" />
			<img src={ `${ process.env.NEXT_PUBLIC_BASE_PATH }/pro_display__c0jmzc5emcae_large.jpg` } alt="" className="w-full" />
		</picture>
	)
}
